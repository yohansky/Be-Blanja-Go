...
func Payment(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "GET" {
		result, err := json.Marshal(paymodel.Select(id).Value)
		if err != nil {
		...
		newPayment := paymodel.Payment{
			Method: input.Method,
			Checkid: input.Checkid,
		}

		paymodel.Updates(id, &newPayment)
